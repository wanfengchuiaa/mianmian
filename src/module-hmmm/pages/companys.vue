  ...
  <div class="companys">
    <el-card>
      ...
      <el-table
        ...
        <el-table-column label="企业编号" prop="number" width="180"></el-table-column>
        <el-table-column label="企业简称" prop="shortName" width="100"></el-table-column>
        <el-table-column label="标签" prop="tags" width="100"></el-table-column>
        <el-table-column label="创建者" prop="creatorID" width="100"></el-table-column>
        <el-table-column :formatter="dateFormat" label="创建日期" prop="addDate" width="180"></el-table-column>
        <el-table-column label="备注" prop="remarks" width="150"></el-table-column>
        <el-table-column :formatter="formatterState" label="状态" prop="state" width="100"></el-table-column>
        <el-table-column label="操作" prop="shortName" width="180">
